...
import com.braintreecv1payments.api.dropin.view.LoadingHeader;
...
public class AddPaymentMethodViewController extends BraintreeViewController implements OnClickListener,
    ...
    private static final String EXTRA_FORM_IS_SUBMITTING = "com.braintreecv1payments.dropin.EXTRA_FORM_IS_SUBMITTING";
    private static final String EXTRA_SUBMIT_BUTTON_ENABLED = "com.braintreecv1payments.dropin.EXTRA_SUBMIT_BUTTON_ENABLED";
    private static final String EXTRA_FOCUS_EVENT_SENT = "com.braintreecv1payments.dropin.EXTRA_FOCUS_EVENT_SENT";
    ...
    private void initViews() {
        mLoadingHeader = findView(com.braintreecv1payments.api.dropin.R.id.bt_header_container);
        mDescription = findView(com.braintreecv1payments.api.dropin.R.id.bt_description_container);
        mPaymentButton = (PaymentButton) mActivity.getFragmentManager()
                .findFragmentById(com.braintreecv1payments.api.dropin.R.id.bt_payment_button);
        mCardForm = findView(com.braintreecv1payments.api.dropin.R.id.bt_card_form);
        mSubmitButton = findView(com.braintreecv1payments.api.dropin.R.id.bt_card_form_submit_button);
    ...
    public void onCardFormValid(boolean valid) {
        ImageButton paypalButton = ((ImageButton) mActivity.findViewById(com.braintreecv1payments.api.dropin.R.id.bt_paypal_monogram_button));
        if(valid) {
            setEnabledSubmitButtonStyle();
    ...
    private void showErrorUI() {
        mLoadingHeader.setError(mActivity.getString(com.braintreecv1payments.api.dropin.R.string.bt_invalid_card));
    }
    ...
    private void setEnabledSubmitButtonStyle() {
        mSubmitButton.setBackgroundResource(com.braintreecv1payments.api.dropin.R.drawable.bt_submit_button_background);
    }

    private void setDisabledSubmitButtonStyle() {
        mSubmitButton.setBackgroundResource(com.braintreecv1payments.api.dropin.R.color.bt_button_disabled_color);
    }
}

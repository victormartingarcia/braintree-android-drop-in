...
public abstract class BraintreeViewController {
    ...
    protected String getCustomizedCallToAction() {
        ...
        if (TextUtils.isEmpty(actionText)) {
            actionText = mActivity.getString(com.braintreecv1payments.api.dropin.R.string.bt_default_submit_button_text);
        }
    ...
    private void initDescriptionView() {
        if (!TextUtils.isEmpty(mPaymentRequest.getPrimaryDescription())) {
            initDescriptionSubview(com.braintreecv1payments.api.dropin.R.id.bt_primary_description, mPaymentRequest
                    .getPrimaryDescription());
            initDescriptionSubview(com.braintreecv1payments.api.dropin.R.id.bt_secondary_description, mPaymentRequest
                    .getSecondaryDescription());
            initDescriptionSubview(com.braintreecv1payments.api.dropin.R.id.bt_description_amount, mPaymentRequest
                    .getAmount());

            findView(com.braintreecv1payments.api.dropin.R.id.bt_description_container).setVisibility(View.VISIBLE);
        }
    }
